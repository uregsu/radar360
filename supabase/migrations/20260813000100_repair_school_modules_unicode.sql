alter table public.school_quality_indicators
alter column source set default 'Escola Total – Qualidade Educacional';
...
create or replace function public.preserve_school_quality_provenance()
returns trigger
language plpgsql
set search_path = public
as $$
