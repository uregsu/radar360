...
import { ActivityFeed, AlertBanner, DataTable, EmptyState as SuperBIEmptyState, ErrorState, LoadingState, MetricCard, PageHeader, SectionHeader, StatusBadge as SuperBIStatusBadge, StrategicCard } from "./SuperBIUI";
...
function badgeTone(value:string){return value==="CRITICA"||value==="CANCELADA"?"danger" as const:value==="ALTA"||value==="SUSPENSA"?"warning" as const:value==="CONCLUIDA"?"success" as const:value==="EM_ANDAMENTO"||value==="EM_ANALISE"?"info" as const:"neutral" as const}
