...
const flow = evaluationFlow("escolas-avaliam-setores")!;
export const metadata: Metadata = { title: `${flow.title} | Avaliação 360 GSU` };

export default function SchoolsEvaluateSectorsPage() {
  return <PublicEvaluationLayout><main className="evaluation-form-page">
    ...
    <header><span className="evaluation-eyebrow">SUPERBI 360 | GSU · AVALIAÇÃO 360</span><h1>{flow.title}</h1><p>Avaliação dos serviços e atendimentos dos setores da URE Guarulhos Sul realizada pelas unidades escolares.</p></header>
